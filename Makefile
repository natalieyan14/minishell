...
SRC = sourses/tokenize.c sourses/tokenize_utils.c sourses/tokenize_handlers.c sourses/validation.c \
      ...
      sourses/dollar.c sourses/dollar_utils.c sourses/heredoc.c sourses/heredoc_utils.c sourses/redirect.c sourses/redirect2.c sourses/redirect3.c sourses/redirect4.c sourses/redirect5.c sourses/pipe.c sourses/pipe_utils.c sourses/exec_external.c sourses/exec_single.c sourses/pipe_exec.c sourses/signals.c \
      sourses/signals2.c sourses/exit_status.c sourses/builtin_3.c sourses/builtin_4.c sourses/builtin_utils.c sourses/unset_utils.c sourses/export_utils.c \
